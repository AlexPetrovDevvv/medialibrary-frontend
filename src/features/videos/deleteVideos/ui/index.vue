<template>
    <Popup v-model="isOpen" @open="open" @close="close" buttonName="Удалить видео" color="error">
        <template #content>
            <v-card width="600" class="px-8 py-8">
                <v-card-title class="text-h4 pa-0">Вы точно хотите удалить видео?</v-card-title>
