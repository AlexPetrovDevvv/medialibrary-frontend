<template>
    <Popup v-model="isOpen" @open="open" @close="close" buttonName="Выход" color="error">
        <template #content>
            <v-card width="600" class="px-8 py-8">
                <v-card-title class="text-h4 pa-0">Вы точно хотите хотите выйти</v-card-title>
                <v-card-actions class="mt-8 px-0 py-0">
                    <v-btn @click.prevent="logout" size="large" variant="flat" color="error">
                        Да
                    </v-btn>
